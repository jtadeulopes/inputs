...
Based on plugins:
  Masked Input Plugin by Josh Bush http://digitalbush.com/projects/masked-input-plugin
  JSMask by Ozéias Sant'ana http://github.com/ozeias/js_mask/tree/master

Copyright (c) 2009 Jésus Lopes jtadeulopes@gmail.com, released under the MIT license
